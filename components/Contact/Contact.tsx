...
import { ContactSectionFragment } from '../../types/types_old';
...
const Contact = ({ data }: ContactSectionFragment) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            //   const res = await ("/api/contact-forms", {
            //     method: "POST",
            //     headers: {
    ...
    return (
        <div className="relative isolate bg-sky-600 mt-10">
                    ...
                    <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <dl className="mt-10 space-y-4 text-base leading-7 text-zinc-300">
                            <div className="flex gap-x-4">
                                ...
                                <dd>
                                    Sagarmatha Complex,Naxal Kathmandu 44600
                                    ,Nepal
                                </dd>
                            </div>
                            <div className="flex gap-x-4">
