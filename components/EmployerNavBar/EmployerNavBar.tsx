...
export default function EmployerNavBar({ user }: NavBarProps) {
        ...
        <header className="flex px-5 h-28 w-full  shrink-0 items-center lg:px-32 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="ml-auto flex items-center gap-2">
                <div className="hidden lg:flex gap-6">
                    ...
                    <DropdownMenu>
                        <Button
                            className="hidden lg:inline-block text-white bg-indigo-500 hover:bg-indigo-700"
                            variant="default"
                            onClick={() => router.push('/employer/Profile')}>
                            View Profile
                        </Button>
                        <Button
                            className="hidden lg:inline-block text-white bg-teal-500 hover:bg-teal-600"
                            variant="default"
                            onClick={() => router.push('/employer/CreateJob')}>
                            Create Job
                        </Button>
                        ...
                        <DropdownMenuContent className="bg-gray-100 shadow-lg px-4">
                            ...
                            <DropdownMenuItem
                                ...
                                onClick={() =>
                                    router.push('/employer/ApplicantView')
                                }>
                                Applicants
                            </DropdownMenuItem>
                            <DropdownMenuItem
                ...
                <SheetContent className="bg-white" side="right">
                    ...
                    <div className="grid gap-6 py-6">
                        <div className="">
                            ...
                            <Button
                                className="mt-3 bg-stone-200 hover:bg-stone-100 hover:underline-offset-8 "
                                onClick={() =>
                                    router.push('/employer/Profile')
                                }>
                                View Profile
                        ...
                        <Button
                            ...
                            className="cursor-pointer text-white bg-blue-500 hover:bg-blue-700"
                            variant="default">
                            Applicants
                        </Button>
                        <Button
